...
CREATE DATABASE IF NOT EXISTS threatsys
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_unicode_ci;

USE threatsys;

-- Main events table: all processed events (normal + problem)
...
-- Alerts table: what /alerts returns to the frontend
...
-- Feedback table: analyst feedback on events
